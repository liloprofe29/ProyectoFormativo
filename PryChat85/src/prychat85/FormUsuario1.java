 ...
 * @author Liliana
 */
public class FormUsuario1 extends javax.swing.JFrame implements Observer {
    ...
    private void initComponents() {
        ...
        jTxMensaje.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTxMensajeActionPerformed(evt);
            }
        });
        ...
        jCbIP.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione ip", "192.168.0.105", "172.16.2.156", "172.16.1.178", "172.16.3.148", "172.16.2.129", "172.16.2.104", "172.16.2.72", "172.16.3.59", "172.16.4.14", "172.16.5.122", "172.16.2.110" }));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jCbIP, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
       String mensaje = "Lili. " + jTxMensaje.getText() + "\n";
       String host = jCbIP.getSelectedItem().toString();
       //Agregar mensaje a textarea
       jTaChat.append(mensaje);
       jTxMensaje.setText("");
       Cliente c = new Cliente(host,6000,mensaje);
       Thread t = new Thread(c);
       t.start();
    }//GEN-LAST:event_jBtEnviarActionPerformed

    private void jTxMensajeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTxMensajeActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTxMensajeActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormUsuario1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormUsuario1().setVisible(true);
            }
        });
    }
